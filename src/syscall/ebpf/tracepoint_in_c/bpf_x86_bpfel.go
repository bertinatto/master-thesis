...
type bpfMapSpecs struct {
	...
	NsMap      *ebpf.MapSpec `ebpf:"ns_map"`
	SyscallMap *ebpf.MapSpec `ebpf:"syscall_map"`
	TrashMap   *ebpf.MapSpec `ebpf:"trash_map"`
}
...
type bpfMaps struct {
	...
	NsMap      *ebpf.Map `ebpf:"ns_map"`
	SyscallMap *ebpf.Map `ebpf:"syscall_map"`
	TrashMap   *ebpf.Map `ebpf:"trash_map"`
}
